...
<div class="d-flex justify-content-end mt-2 me-2 text-center">
	...
	<div class="outer-container d-flex align-items-center justify-content-center align-items-center">
        ...
        <form action="userlogin"> 
        	<h2 class="fs-5 text-wrap text-center">User Sign In</h2>
        	<div class="mb-4">
			...
			<div class="mb-4">
				...
				<input type="text" class="form-control" name="mobilenumber" id="exampleFormControlInput2" placeholder="9999999999">
			</div>
